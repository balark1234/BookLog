package com.brk.booklogger.data.notifications
...
import com.brk.booklogger.MainActivity
...
object ReadingNotificationHelper {
    ...
    private val encouragementTitles = listOf(
        "ðŸ“š Time for an adventure!",
        "ðŸŒŸ Your book is waiting!",
        "ðŸ”¥ Keep your streak alive!",
        "ðŸ“– Story time calling!",
        "ðŸ¦¸ Be a reading hero today!",
        "ðŸŽ¯ Pages = rewards!",
        "ðŸŒˆ Discover something new!",
    )

    private val encouragementBodies = listOf(
        "Even a few pages today keeps your reading superpowers strong.",
        "Open BookLog and log a page â€” every page earns a penny toward rewards!",
    ...
    private val missReminderTitles = listOf(
        ...
        "Your books are lonely ðŸ“š",
        "Streak on pause â€” jump back in!",
        "4 days left to rebuild momentum",
        "Last chance this week!",
    )

    private val missReminderBodies = listOf(
        "You missed yesterday â€” no worries! Open BookLog and read just one page to restart.",
        "Two days without reading. A quick 5-minute story can bring your streak back!",
        "Three days away from books. Your rewards are waiting â€” log a page today!",
        "Four missed days. Heroes come back stronger â€” pick any book and read one page.",

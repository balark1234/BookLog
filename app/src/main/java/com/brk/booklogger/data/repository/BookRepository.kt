...
import com.brk.booklogger.data.remote.ApiErrorMapper
import com.brk.booklogger.data.remote.CoverUrlResolver
import com.brk.booklogger.data.remote.BookSearchResult
import com.brk.booklogger.data.remote.OpenLibraryApi
import com.brk.booklogger.data.remote.OpenLibraryBookResponse
import com.brk.booklogger.data.remote.OpenLibrarySearchDoc
...
class BookRepository(private val bookDao: BookDao) {
    ...
    private fun com.brk.booklogger.data.remote.OpenLibraryIsbnRecord.toBook(isbn: String): Book {

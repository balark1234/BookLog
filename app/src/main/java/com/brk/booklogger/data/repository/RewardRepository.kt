...
import com.brk.booklogger.data.remote.CoverUrlResolver
import com.brk.booklogger.data.local.ReadingDayLog
...
import com.brk.booklogger.data.rewards.RewardCalculator
import com.brk.booklogger.data.rewards.RewardDirection
import com.brk.booklogger.data.rewards.RewardTransactionType
...
class RewardRepository(
    ...
    fun observeEarnedCents(kidProfileId: Long?): Flow<Int> =
        when (kidProfileId) {
            null -> rewardTransactionDao.observeSumCentsForParent(RewardDirection.CREDIT.name)
            else -> rewardTransactionDao.observeSumCentsForKid(kidProfileId, RewardDirection.CREDIT.name)
        }

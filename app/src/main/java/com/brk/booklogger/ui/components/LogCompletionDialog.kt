...
import com.brk.booklogger.data.rewards.RewardBreakdown
    ...
    AlertDialog(
        ...
        confirmButton = {
            Button(
                ...
                Text(if (isSaving) "Savingâ€¦" else "Save & Earn Rewards")
            }
        },
        dismissButton = {
...
private fun formatHistoryLine(entry: CompletedBook): String {
    ...
    return "#${entry.readCountNumber} Â· ${entry.minutesRead} min Â· ${RewardRepository.formatCents(entry.totalRewardCents)} Â· $date"
}
...
import com.brk.booklogger.ui.components.BookCover
...
import com.brk.booklogger.viewmodel.AddBookEvent
...
fun AddBookScreen(
    ...
    onBack: () -> Unit,
    onSaved: (com.brk.booklogger.data.local.Book) -> Unit,
            ...
            if (state.saveSuccess) {
                Card(
                    ...
                    Row(
                        ...
                        Text("Saved! Taking you to your libraryâ€¦", fontWeight = FontWeight.Bold)
                    }
                }
            }
